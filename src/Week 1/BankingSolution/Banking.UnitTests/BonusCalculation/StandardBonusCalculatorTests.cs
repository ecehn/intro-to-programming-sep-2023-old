...
public class StandardBonusCalculatorTests
{
    ...
    public void AccountsThatMeetTheCriteriaGetTheBonus(decimal balance, decimal deposit, decimal expecteBonus)
    {
        ...
        Assert.Equal(expecteBonus, bonus);
    }

    [Theory]
    [InlineData(4999.99, 100, 0)]

    public void AccountsThatDoNotMeetTheCriteriaGetNoBonus(decimal balance, decimal deposit, decimal expecteBonus)
    {
        var bonusCalculator = new StandardBonusCalculator();
